test_that("table works", {
  ...
  expect_true(all(c('Codelist name', 'CDM name', 'Concept name', 'Concept ID', 'Variable name', 'Value as concept name', 'Value as concept ID', 'Estimate name', 'Estimate value') %in% colnames(x$`_data`)))
