test_that("summariseMeasurementUse works", {
  ...
  expect_equal(
    res |>
      ...
      dplyr::pull(estimate_value) |>
      sort(),
    c("2", "3", "4", "47.2863658494316", "47.2863658494316", "47.2863658494316", "47.2863658494316",
      "47.2863658494316", "47.2863658494316", "47.2863658494316", "47.2863658494316", "47.2863658494316",
      "47.2863658494316", "50", "50", "6")
  )
  expect_equal(
    res |>
      omopgenerics::filterSettings(result_type == "measurement_value_as_numeric") |>
